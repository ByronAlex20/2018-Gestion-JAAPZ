...
public class Context {
	...
	public List<Inspeccion> getListaInspecciones() {
		return listaInspecciones;
	}


	public void setListaInspecciones(List<Inspeccion> listaInspecciones) {
	...
	public CuentaCliente getCuentas() {
		return cuentas;
	}


	public void setCuentas(CuentaCliente cuentas) {
